...
public class Data {
    ...
    //English - 10 items (animals)
    public String animalNamesData = Arrays.toString(new String[]{"Frog", "Crocodile", "Lion", "Tiger", "Goat", "Horse", "Donkey", "Cheetah", "Cow", "Giraffe"});

    public static Integer[] animalImages = {R.drawable.frog, R.drawable.crocodile, R.drawable.lion,
            R.drawable.tiger, R.drawable.goat, R.drawable.horse, R.drawable.donkey, R.drawable.cheetah, R.drawable.cow, R.drawable.giraffe};

    public String animalDescription[] = {"In general, frogs have protruding eyes, no tail, and strong, webbed hind feet that are adapted for leaping and swimming. They also possess smooth, moist skins. Many are predominantly aquatic, but some live on land, in burrows, or in trees.",
